<%@ Page Title="Gestisci password" Language="vb" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="false" CodeBehind="ManagePassword.aspx.vb" Inherits="Acom1.ManagePassword" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="OtherContent" runat="server">
    <h2><%: Title %>.</h2>
