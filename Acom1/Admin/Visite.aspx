<%@ Page Title="Ricerca Eventi" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/AdminMaster.master" CodeBehind="Visite.aspx.vb" Inherits="Acom1.Visite" %>
...
<asp:Content ID="Content1" runat="server" contentplaceholderid="OtherContent">
    ...
    <asp:GridView ID="GridViewVisit"  DataKeyNames="ID" runat="server" SelectMethod="GridViewVisit_GetData" AutoGenerateColumns="false" AllowSorting="true" CssClass="table table-hover table-bordered table-responsive" HeaderStyle-BackColor="#DCF5FD" HeaderStyle-Font-Bold="true">
        <Columns>
            <asp:HyperLinkField Text="Modifica" NavigateUrl="~/Admin/VisiteIns.aspx" DataNavigateUrlFields="ID" DataNavigateUrlFormatString="~/Admin/VisiteIns.aspx?ID={0}" />
            ...
            <asp:BoundField DataField="createdby" HeaderText="Creato da" />
            <asp:BoundField DataField="data_ins" HeaderText="Creato il" DataFormatString="{0:dd/MM/yyyy}"/>
            <asp:BoundField DataField="updatedby" HeaderText="Aggiornato da" />
            <asp:BoundField DataField="data_upd" HeaderText="Aggiornato il" DataFormatString="{0:dd/MM/yyyy}" />
        </Columns>
    </asp:GridView>
</asp:Content>
