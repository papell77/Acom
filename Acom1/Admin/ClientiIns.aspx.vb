...
Public Class ClientiIns
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If id = 0 Then
            ...
            FormClientIns.ChangeMode(FormViewMode.Insert)
    ...
    Protected Sub cmd_nuovo_Click(sender As Object, e As EventArgs)
        ...
        Try
            ctx.SaveChanges()
            Response.Redirect("~/Admin/ClientiIns?ID=" & id)
    ...
    Protected Sub cmd_cancel_Click(sender As Object, e As EventArgs)
        If FormClientIns.CurrentMode = FormViewMode.Insert Then
            Response.Redirect("~/Admin/ClientiIns")
        Else
    ...
    Public Sub FormClientIns_InsertItem()
        ...
        If ModelState.IsValid Then
            ...
            Try
                ...
                ctx.SaveChanges()
                Response.Redirect("~/Admin/ClientiIns?ID=" & item.ID)
