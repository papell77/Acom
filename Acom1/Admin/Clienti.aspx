<%@ Page Title="Ricerca Clienti" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/AdminMaster.master" CodeBehind="Clienti.aspx.vb" Inherits="Acom1.Clienti1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="OtherContent" runat="server">
    ...
    <asp:GridView ID="GridViewClients" DataKeyNames="ID" runat="server" SelectMethod="GridViewClients_GetData" AutoGenerateColumns="False" CssClass="table table-hover table-bordered table-responsive" HeaderStyle-BackColor="#DCF5FD" HeaderStyle-Font-Bold="true">
        <Columns>
            <asp:HyperLinkField Text="Dettaglio" NavigateUrl="~/Admin/ClientiIns.aspx" DataNavigateUrlFields="ID" DataNavigateUrlFormatString="~/Admin/ClientiIns.aspx?ID={0}" />
            ...
            <asp:BoundField DataField="created_date" HeaderText="Creato il" />
            <asp:BoundField DataField="updated_by" HeaderText="Modificato da" />
            <asp:BoundField DataField="data_aggiornamento" HeaderText="Modificato il" />
        </Columns>
    ...
    <asp:GridView runat="server" ID="GridViewOffice" DataKeyNames="ID" SelectMethod="GridViewOffice_GetData" AutoGenerateColumns="false" CssClass="table table-hover table-bordered table-responsive" HeaderStyle-BackColor="#DCF5FD" HeaderStyle-Font-Bold="true">
        <Columns>
            <asp:HyperLinkField Text="Dettaglio" NavigateUrl="~/Admin/FilialiIns.aspx" DataNavigateUrlFields="ID, clientID" DataNavigateUrlFormatString="~/Admin/FilialiIns.aspx?ID_of={0}&ID_cl={1}" />
            ...
            <asp:BoundField DataField="created_date" HeaderText="Creato il" />
            <asp:BoundField DataField="updated_by" HeaderText="Modificato da" />
            <asp:BoundField DataField="updated_date" HeaderText="Modificato il" />
        </Columns>
    </asp:GridView>
</asp:Content>