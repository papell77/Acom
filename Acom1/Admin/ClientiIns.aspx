<%@ Page Title="Clienti" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/AdminMaster.master" CodeBehind="ClientiIns.aspx.vb" Inherits="Acom1.ClientiIns" %>
<asp:Content ID="Content1" ContentPlaceHolderID="OtherContent" runat="server">
        ...
        <asp:FormView ID="FormClientIns" runat="server" SelectMethod="FormClientIns_GetItem" DataKeyNames="ID" UpdateMethod="FormClientIns_UpdateItem" OnItemUpdated="FormClientIns_ItemUpdated" InsertMethod="FormClientIns_InsertItem" OnItemInserted="FormClientIns_ItemInserted"  >
            ...
            <table class="acomtable" >
                ...
                <tr >
                    ...
                    <td ><asp:Label runat="server" text='<%# Eval("created_date", "{0:dd/MM/yyyy)}")%>' CssClass="form-control"  ></asp:Label> </td>
                </tr>
                <tr >
                    ...
                    <td ><asp:Label runat="server" text='<%# Eval("data_aggiornamento", "{0:dd/MM/yyyy}")%>' CssClass="form-control"  ></asp:Label> </td>
                </tr>
                <tr class="acomtable-section-intest">
 ...
 <%--     <InsertItemTemplate>
            ...
            <table class="acomtable" >
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator runat="server" ValidationGroup="client" ID="required_ragsoc" ControlToValidate="ragione_sociale" ErrorMessage="Inserire ragione sociale" SetFocusOnError="true" Display="None" ></asp:RequiredFieldValidator>               
                    </td>
                </tr>
                <tr >
                    <td class="form-label" style="text-align:right" >Canale:</td>
    ...
    <p>
        <asp:Button ID="cmd_modifica" Text="Attiva" OnClick="cmd_modifica_Click" runat="server" CssClass="btn btn-primary btn-hover" />
        <asp:Button ID="cmd_nuovo" OnClick="cmd_nuovo_Click" Text="Disattiva" runat="server" CssClass="btn btn-primary btn-hover" />
    </p>
    <p>
    ...
    <asp:ValidationSummary runat="server" CssClass="alert alert-danger" DisplayMode="BulletList" ShowMessageBox="false" ShowModelStateErrors="true" ShowSummary="true" ShowValidationErrors="true" ValidationGroup="contact_edit"/>
        <br />
         <asp:ListView ID="ListViewContacts" runat="server" DataKeyNames="ID" DataSourceID="SqlDataSourceContacts">
...
<%--            <EditItemTemplate>
                <tr>
                    ...
                    <td>
                        <asp:label ID="created_date" runat="server" Text='<%# Bind("created_date")%>'/>
                    </td>
                    <td>
                        <asp:label ID="updated_by" runat="server" Text='<%# Bind("updated_by")%>' />
                    </td>
                    <td>
                        <asp:label ID="updated_date" runat="server" Text='<%# Bind("updated_date")%>'/>
