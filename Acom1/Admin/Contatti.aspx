<%@ Page Title="Contatti" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/AdminMaster.master" CodeBehind="Contatti.aspx.vb" Inherits="Acom1.Contatti" %>
...
<asp:Content ID="Content1" runat="server" contentplaceholderid="OtherContent">
    ...
    <asp:GridView ID="GridViewContact" runat="server" DataKeyNames="ID" AutoGenerateColumns="false" SelectMethod="GridViewContact_GetData" CssClass="table table-hover table-bordered table-responsive" HeaderStyle-BackColor="#DCF5FD" HeaderStyle-Font-Bold="true" >
        <Columns>
            ...
            <asp:BoundField DataField="created_date" HeaderText="Data inserimento" Visible="true"/>
            <asp:BoundField DataField="updated_by" HeaderText="Aggiornato da" Visible="true"/>
            <asp:BoundField DataField="updated_date" HeaderText="Data aggiornamento" Visible="true"/>
          </Columns>
        </asp:GridView>
