Public Class AnagraficaProvincie
    ...
    Protected Sub ListView1_ItemInserting(sender As Object, e As ListViewInsertEventArgs)
        SqlDataSourceProv.InsertParameters("created_by").DefaultValue = User.Identity.Name
        SqlDataSourceProv.InsertParameters("created_date").DefaultValue = Now
    ...
    Protected Sub SqlDataSourceProv_Updating(sender As Object, e As SqlDataSourceCommandEventArgs)
