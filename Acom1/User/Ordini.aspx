<%@ Page Title="Ordini" Language="vb" AutoEventWireup="false" MasterPageFile="~/User/UserMaster.master" CodeBehind="Ordini.aspx.vb" Inherits="Acom1.Ordini1" %>
<asp:Content ID="Content1" runat="server" contentplaceholderid="OtherContent">
    ...
    <asp:Table ID="TableFindOrder" runat="server">    
        ...
        <asp:TableRow ID="rif_impianto" runat="server" >
            ...
            <asp:TableCell ID="txtDDLfamily" runat="server">
                <asp:DropDownList ID="familyID" runat="server" SelectMethod="Get_families" DataValueField="ID" DataTextField="family_name" AppendDataBoundItems="true" CssClass="form-control">
    ...
    <h5>In giallo sono evidenziati gli ordini privi di dettaglio prodotti</h5>
        ...
        <Columns>
            <asp:HyperLinkField Text="Dettaglio" NavigateUrl="~/User/OrdiniIns.aspx" DataNavigateUrlFields="ID" DataNavigateUrlFormatString="~/User/OrdiniIns.aspx?ID={0}" />
            <asp:BoundField DataField="ID" Visible="false" />
            <asp:BoundField DataField="order_code" HeaderText="Ordine n." />
            ...
            <%-- <asp:BoundField DataField="product_name" HeaderText="Prodotto" />--%>
            <asp:BoundField DataField="rif_impianto" HeaderText="Rif. impianto" />
            <asp:BoundField DataField="rif_offerta" HeaderText="Offerta" />
...
<%--            <asp:BoundField DataField="num_product" HeaderText="Numero prodotti" />--%>
            <%-- <asp:BoundField DataField="created_by" HeaderText="Inserito da" Visible="false" />
            <asp:BoundField DataField="created_by" HeaderText="Data inserimento" Visible="false" />
