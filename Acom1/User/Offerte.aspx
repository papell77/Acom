<%@ Page Title="Offerte" Language="vb" AutoEventWireup="false" MasterPageFile="~/User/UserMaster.master" CodeBehind="Offerte.aspx.vb" Inherits="Acom1.Offerte1" %>
<asp:Content ID="Content1" runat="server" contentplaceholderid="OtherContent">
    ...
    <ContentTemplate>
        <p style="padding:10px">
            ...
            <asp:ValidationSummary runat="server" ID="val_summary" CssClass="alert alert-danger" DisplayMode="BulletList" ShowMessageBox="false" ShowSummary="true" ShowValidationErrors="true" ShowModelStateErrors="true" />
        </p>
    ...
    <br />
    <asp:Button ID="btnCercaVisita" runat="server" CssClass="btn btn-primary btn-hover" Text="Cerca Offerta" OnClick="btnCercaVisita_Click" />
    ...
    <asp:GridView ID="GridViewOffer" runat="server" DataKeyNames="ID" AutoGenerateColumns="False" CssClass="table table-hover table-bordered table-responsive" >
        ...
        <Columns>
            <asp:HyperLinkField Text="Dettaglio" NavigateUrl="~/User/OfferteIns.aspx" DataNavigateUrlFields="ID" DataNavigateUrlFormatString="~/User/OfferteIns.aspx?ID={0}" />
            <asp:BoundField DataField="ID" Visible="false" />
            <asp:BoundField DataField="offer_code" HeaderText="Offerta" SortExpression="offer_code" />
